...
export function SeatNotificationBanner({ notifications, onDismiss }: Props) {
  if (notifications.length === 0) return null;

  return (
    <div className="absolute top-3 left-1/2 -translate-x-1/2 z-30 flex flex-col gap-2 w-[90%] max-w-lg">
      {notifications.map(n => (
        <div
          key={n.id}
