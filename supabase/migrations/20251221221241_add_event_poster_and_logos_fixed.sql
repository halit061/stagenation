...
DROP POLICY IF EXISTS "Public can view logos for active events" ON event_logos;
CREATE POLICY "Public can view logos for active events"
...
DROP POLICY IF EXISTS "Super admins can manage all event logos" ON event_logos;
